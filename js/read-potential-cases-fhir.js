...
(async () => {
  ...
  await fs.writeFile("hyperkinetic-disorders-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("hyperkinetic-disorders-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
